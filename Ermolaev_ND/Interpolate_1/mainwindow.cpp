...
void MainWindow::paintEvent(QPaintEvent *event) {
    ...
    auto apprxLines = functionLines(std::bind(&MainWindow::f_aprox, this, std::placeholders::_1), view);
    auto fnMinusApprxLines = functionLines([&](double x) { return std::abs(currentFunction()(x) - f_aprox(x)); }, view);
    ...
    QPair<double, double> fnMinusApprxMinMax = functionMinMax([&](double x) { return std::abs(currentFunction()(x) - f_aprox(x)); }, view);
